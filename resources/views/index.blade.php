...
@section('content')
    ...
    <marquee align="center" height="500" width="100%" scrolldelay="4" scrollamount="5" onmouseout="this.start()" onmouseover="this.stop()">

      <p><img border="0" src="img/img1.png"  width="70%" height="500" alt="" hspace="0">
      <img border="0" src="img/img2.png" alt="" width="70%" height="500" hspace="0">
      </p></marquee>
